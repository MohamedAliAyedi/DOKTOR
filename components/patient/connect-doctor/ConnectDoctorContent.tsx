...
export function ConnectDoctorContent() {
  ...
  const handleConnectByDoctorId = async () => {
    if (!doctorId) {
      toast({
        title: "Error",
    ...
    setIsLoading(true);
    try {
      await doctorsAPI.connectToDoctor(doctorId, {
        message: "I would like to connect with you as my doctor"
      });
  ...
  return (
    <div className="space-y-6 relative mt-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12 bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-2 border-gray-50">
        {/* Left Column - Connect to My Doctor */}
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-pink-500">
            Connect to My Doctor
          </h2>
          ...
          <div className="space-y-4">
            <div>
              ...
              />
              <Button
                onClick={handleConnectByDoctorId}
